  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-10 text-slate-950">
      <section className="mx-auto max-w-2xl">
        ...
        {!showPayment ? (
          <form onSubmit={handleBookingSubmit} className="mt-8 space-y-5 rounded-md border bg-white p-6">
          ...
          <div className="mt-8 rounded-md border bg-white p-6">
            ...
            <form onSubmit={handlePaymentSubmit} className="mt-6 space-y-5">
              ...
              <button disabled={paymentLoading} className="w-full rounded-md bg-green-600 px-5 py-3 font-semibold text-white disabled:bg-slate-400">
